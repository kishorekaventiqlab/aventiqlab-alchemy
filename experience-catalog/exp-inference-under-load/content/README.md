...
| Video | [`video-script.md`](video-script.md) (narration/shot list) + [`/video-studio`](../../../video-studio/) (Remotion composition `inference-under-load-video`, renders to `.mp4`) | ✅ Finished script; rendered video in `video-studio/out/` |
